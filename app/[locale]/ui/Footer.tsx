      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 px-6 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
            ...
            <div>
              <h2 className="mb-0 text-sm font-semibold uppercase text-white">
                {t("FOOTER.PRODUCED_BY")}
              </h2>
              <a href="https://www.ubiq.ad/" target="_blank" rel="noreferrer">
                <img
                  src="https://premiosesland.com/assets/UBIQ_LOGO.c719aeaa.svg"
                  alt="Logo Ubiq"
                />
              </a>
            </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-4 flex sm:mt-0 sm:justify-center">
            <Link
              href="https://github.com/danidz96/esland-web"
              className="text-gray-500hover:text-white ms-5"
            >
              <svg
                className="h-4 w-4"
                aria-hidden="true"
